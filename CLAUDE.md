...
web/                      # Vite + React SPA (artist dashboard)
  ...
  src/components/         # Shared components (captures-table, stat-card, show-drill-down, daily-chart, broadcast-engagement, dashboard-tonight, dashboard-all-shows, email-template-dialog, keyword-dialog, page-form, pwa-*)
